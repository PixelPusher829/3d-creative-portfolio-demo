...
type ContentIndexType = SvelteComponent<Record<string, unknown>, ContentIndexType, Context>;

type Context = { client: Client<Content.AllDocumentTypes> };

const mapper: SliceMapper<Content.ContentIndexSlice, ComponentProps<ContentIndexType>, Context>
	= async ({ slice, context }) => {
